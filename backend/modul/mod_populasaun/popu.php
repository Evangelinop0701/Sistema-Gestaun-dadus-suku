                ...
                <div class="card rounded-1">
                    ...
                    <div class="card-body pt-1">
                        <table class="table table-bordered mt-2">
                            ...
                            <?php
                $id_al = $_SESSION['id_aldeia'];
    $all_ativos = $populasaun->popu_ativos($id_al);?>
                            <tr>
                                <td class="py-1 text-center"><a
                                        href="dados-populasaun-<?= $all_ativos[0]['id_aldeia']; ?>.html"
                                        style="text-decoration:none;">Aldeia
                                        [<?= $all_ativos[0]['naran_aldeia'] ?>]</a></td>
                            </tr>
...
<?php } elseif ($_SESSION['kargu'] == "Sekretaria" | $_SESSION['level_user'] == "superadmin") { ?>
<div class="container p-4">
    <div class="col-lg-12">
        <div class="row">
            <div class="col-3"></div>
        ...
        <div class="card rounded-1 shadow-sm" id="card">
            ...
            <div class="card-body">
                <div class="container">
                    ...
                    <a href="input-popu-<?=$_GET['id_aldeia']?>.html" class="btn btn-sm px-2 mb-2 btn-success py-1"><i
            ...
            ?>
                                <tr>
                                    ...
                                    <td class="py-1"><a id="class" style="text-decoration:none;"
                                            href="detalho-populasaun-<?=$row['id_populasaun']?>-aldeia-<?=$row['id_aldeia'] ?>.html"><?= $row['naran_populasaun']; ?></a>
                                    </td>
                                    ...
                                    <?php if ($_SESSION['kargu'] == "Sekretaria" | $_SESSION['level_user'] == "superadmin") { ?>
                                    <td class="py-1">
                                        <a href="update-populasaun-<?=$row['id_populasaun']?>-<?=$row['id_aldeia']?>.html"
                                            class="btn btn-sm py-0 btn-primary "><i class="fa fa-edit"></i>
                                            Hadia</a>
                                        <a href="modul/mod_populasaun/aksi.php?act=delete&id=<?=$row['id_populasaun'];?>"
...
<div class="container p-4">
    ...
    <div class="col-lg-12">
        ...
        <ol class="breadcrumb rounded-1 px-2 py-1">
            <li class="breadcrumb-item"><a href="index.html">Home</a></li>
            <li class="breadcrumb-item"><a href="dados-populasaun-<?=$_GET['id_aldeia']?>.html">Dados Populasaun</a>
            </li>
            <li class="breadcrumb-item active">Aumenta dados Populasaun</li>
        </ol>
        <div class="card rounded-1 shadow-sm" id="card">
            <div class="card-header rounded-0" id="card-header">
                <div class="card-title my-0 text-uppercase">
                    Aumenta dados Populasaun
                </div>
            </div>
            <div class="card-body">
                <div class="container">
                    <form action="modul/mod_populasaun/aksi.php?act=input" method="POST">
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-3">
                                    <label for="" class="form-label">Nu.Eleitoral<sub style="color:red;">*</sub></label>
                                    <input type="text" class="form-control form-control-sm" id="" name="no_eleitoral"
                                        aria-describedby="emailHelp" placeholder="Prense No.Eleitoral" required>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="mb-3">
                                    <label for="" class="form-label">Naran Populasaun<sub
                                            style="color:red;">*</sub></label>
                                    <input type="text" name="naran_populasaun" class="form-control form-control-sm"
                                        placeholder="Prense naran Populasaun" required>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="mb-3">
                                    <label for="" class="form-label">Sexu<sub style="color:red;">*</sub></label>
                                    <select name="sexu" class="form-control form-control-sm" required>
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="data_moris" class="form-control form-control-sm" required>
                                </div>
                            </div>

                            <div class="col-4">
                                <div class="mb-3">
                                    <label for="" class="form-label">Postu-Suku-Aldeia<sub
                                            style="color:red;">*</sub></label>
                                    <select name="id_aldeia" class="form-control form-control-sm" required>
                                        <?php
                                        $data = $aldeia->dados_aldeia();
        foreach ($data as $row) { ?>
                                        <option value="<?= $row['id_aldeia']; ?>">
                                            <?=$row['naran_postu'] ?>-<?=$row['naran_suku'] ?>-<?=$row['naran_aldeia'] ?>
                                        </option>
                                        <?php } ?>
                                    </select>
                                </div>
                            ...
                            <div class="col-4">
                                <div class="mb-3">
                                    <label for="" class="form-label">Relijiaun<sub style="color:red;">*</sub></label>
                                    <input type="text" name="religiaun" class="form-control form-control-sm"
                                        placeholder="Prense Relijiaun" required>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="mb-3">
                                    <label for="" class="form-label">Estatus<sub style="color:red;">*</sub></label>
                            ...
                            <div class="col-4">
                                <div class="mb-3">
                                    <label for="" class="form-label">Estadu Sivil<sub style="color:red;">*</sub></label>
                                    <select name="s_civil" class="form-control form-control-sm" required>
                            ...
                            <div class="col-4">
                                <div class="mb-3">
                                    <label for="" class="form-label">Profisaun<sub style="color:red;">*</sub></label>
                                    <input type="text" name="profisaun" class="form-control form-control-sm"
                                        placeholder="Prense Profisaun" required>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="mb-3">
                                    <label for="" class="form-label">Residensia Atual<sub
                                            style="color:red;">*</sub></label>
                                    <input type="text" name="residensia_atual" class="form-control form-control-sm"
                                        placeholder="Prense Residensia Atual" required>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="mb-3">
...
<div class="container p-4">
    ...
    <div class="col-lg-12">
        ...
        <ol class="breadcrumb rounded-1 px-2 py-1">
            ...
            <li class="breadcrumb-item active">Hadia Populasaun</li>
        </ol>
        <div class="card rounded-1 shadow-sm" id="card">
            <div class="card-header rounded-0" id="card-header">
                <div class="card-title my-0">
                    Hadia dados Populasaun
                </div>
            </div>
            <div class="card-body">
                <div class="container">
                    <form action="modul/mod_populasaun/aksi.php?act=update&id=<?= $id; ?>" method="POST">
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-3">
                                    <label for="" class="form-label">Nu.Eleitoral<sub style="color:red;">*</sub></label>
                                    <input type="text" value="<?= $up[0]['no_eleitoral']; ?>"
                                        class="form-control form-control-sm" id="" name="no_eleitoral"
                                        aria-describedby="emailHelp" placeholder="Prense No.Eleitoral" required>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="mb-3">
                                    <label for="" class="form-label">Naran Populasaun<sub
                                            style="color:red;">*</sub></label>
                                    <input type="text" name="naran_populasaun" class="form-control form-control-sm"
                                        placeholder="Prense naran Populasaun" value="<?= $up[0]['naran_populasaun']; ?>"
                                        required>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="mb-3">
                                    <label for="" class="form-label">Sexu<sub style="color:red;">*</sub></label>
                                    <select name="sexu" class="form-control form-control-sm" required>
                                        <option value="<?= $up[0]['sexu']; ?>" selected hidden><?php
                                         if ($up[0]['sexu'] == "M") {
                                             echo "Mane";
                                         } else {
                                             echo "Feto";
        ...
        foreach ($data as $row) { ?>
                            ...
                            <div class="col-4">
                                <div class="mb-3">
                                    <label for="" class="form-label">Relijiaun<sub style="color:red;">*</sub></label>
                                    <input type="text" value="<?= $up[0]['religiaun'];  ?>" name="religiaun"
                                        class="form-control form-control-sm" placeholder="Prense Relijiaun" required>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="mb-3">
                                    <label for="" class="form-label">Estatus<sub style="color:red;">*</sub></label>
                                    <select name="status" class="form-control form-control-sm" required>
                                        <option value="<?= $up[0]['status']; ?>" selected hidden>
                                            <?= $up[0]['status']; ?></option>
                                        <option value="Moris">Moris</option>
                                        <option value="Mate">Mate</option>
                                    </select>
                            ...
                            <div class="col-4">
                                <div class="mb-3">
                                    <label for="" class="form-label">Estadu Sivil<sub style="color:red;">*</sub></label>
                                    <select name="s_civil" class="form-control form-control-sm" required>
                                        <option value="<?= $up[0]['s_civil']; ?>" selected hidden>
                                            <?= $up[0]['s_civil']; ?></option>
                                        <option value="Solteiro">Solteiro</option>
                                        <option value="Kassadu">Kassadu</option>
                                        <option value="Barlakeadu">Barlakeadu</option>
                            ...
                            <div class="col-4">
                                <div class="mb-3">
                                    <label for="" class="form-label">Profisaun<sub style="color:red;">*</sub></label>
                                    <input type="text" value="<?= $up[0]['profisaun'];  ?>" name="profisaun"
                                        class="form-control form-control-sm" placeholder="Prense Profisaun" required>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="mb-3">
                                    <label for="" class="form-label">Residensia Atual<sub
                                            style="color:red;">*</sub></label>
                                    <input type="text" value="<?= $up[0]['residensia_atual'];  ?>"
                                        name="residensia_atual" class="form-control form-control-sm"
                                        placeholder="Prense Residensia Atual" required>
                                </div>
                            </div>
                            <div class="col-4">
